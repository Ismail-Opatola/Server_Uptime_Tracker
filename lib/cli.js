...
cli.responders.stats = () => {
  ...
  const stats = {
    ...
    "Allocated Heap Used (%)": Math.random(v8.getHeapStatistics().used_heap_size / v8.getHeapStatistics().total_heap_size * 100),
    "Available Heap Allocated (%)": Math.random(v8.getHeapStatistics().total_heap_size / v8.getHeapStatistics().heap_size_limit * 100),
